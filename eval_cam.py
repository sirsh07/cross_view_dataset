...
def main():
    ...
    if os.path.exists("./cache_files2/master_folders_sfm2.txt"):
        with open("./cache_files2/master_folders_sfm2.txt", "r") as f:
            master_folders = f.read().splitlines()
    else:
        master_folders = get_all_mast3r_folders("/home/sirsh/cv_dataset/dataset_30sites/mast3r_sfm_v2")
        with open("./cache_files2/master_folders_sfm2.txt", "w") as f:
            f.write("\n".join(master_folders))
