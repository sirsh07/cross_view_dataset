...
def main():
    ...
    if os.path.exists("./cache_files2/colmap_folders_sat.txt"):
        with open("./cache_files2/colmap_folders_sat.txt", "r") as f:
            colmap_folders = f.read().splitlines()
    else:
        colmap_folders = get_all_colmap_folders("/home/sirsh/cv_dataset/dataset_10sites/colmap")
        with open("./cache_files2/colmap_folders_sat.txt", "w") as f:
            f.write("\n".join(colmap_folders))
    ...
    if os.path.exists("./cache_files2/master_folders_sfm2_sat.txt"):
        with open("./cache_files2/master_folders_sfm2_sat.txt", "r") as f:
            master_folders = f.read().splitlines()
    else:
        master_folders = get_all_mast3r_folders("/home/sirsh/cv_dataset/dataset_10sites/mast3r_sfm")
        with open("./cache_files2/master_folders_sfm2_sat.txt", "w") as f:
            f.write("\n".join(master_folders))
